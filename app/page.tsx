      ...
      <section className={css.hero}>
        <header className={css.header}>
          ...
          <p className={css.subtitle}>
            Manage, organize, and access your personal notes effortlessly and securely in one place.
          </p>
        </header>
      ...
      <section className={css.features}>
        ...
        <ul className={css.featuresList}>
          <li className={css.featureItem}>
            <strong>Fast Search:</strong> Quickly find notes by title or content.
          </li>
          <li className={css.featureItem}>
            <strong>Easy Management:</strong> Create, view, and delete notes easily.
          </li>
          <li className={css.featureItem}>
